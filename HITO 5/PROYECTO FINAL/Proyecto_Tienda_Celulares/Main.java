...
public class Main {
    ...
    public static void main (String[] args)
    {
        ...
        Celulares cel1 = new Celulares(654653213, "Samsung J7", "1200 bs");
        Celulares cel2 = new Celulares(546546548, "Samsung Galaxy S10", "2500 bs");
        Celulares cel3 = new Celulares(987984654, "Huawei p20 pro", "1000 bs");
        Celulares cel4 = new Celulares(645987946, "Tecno camon 16", "900 bs");
        Celulares cel5 = new Celulares(654987984, "Realme 8", "1100 bs");
...
//----------------------------------------------------------------------------------------------------------------------
        Accesorios Acc1 = new Accesorios(1, "Auriculares", "20 bs");
        Accesorios Acc2 = new Accesorios(2, "Microfonos", "15 bs");
        Accesorios Acc3 = new Accesorios(3, "Parlantes", "40 bs");
        Accesorios Acc4 = new Accesorios(4, "Fundas", "25 bs");
        Accesorios Acc5 = new Accesorios(5, "Memoria 64Gb", "40 bs");
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    //Marcar que el celular esta vendido
    public static void CelularesVendidos(Cola_Celulares Ncels, String modelo, String Venta)
    {
        ...
        while (!Ncels.esVacio())
        {
            ...
            if (DatoMod.getMarca().equals(modelo) && DatoMod.getPrecio().equals(Venta) )
            {
